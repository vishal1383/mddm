...
bash Token2Token/experiments/scripts/run_decoder_sweep50_round2.sh || echo "round 2 failed"

echo "=== v4a evaluation ==="
NAME=v4a bash Token2Token/experiments/scripts/run_parallel_unlock_v4.sh || echo "v4a eval failed"

echo "=== full base benchmark, 1319 examples ==="
BATCH=16 LIMIT=1319 bash Token2Token/experiments/scripts/run_full_benchmark.sh || echo "full benchmark failed"
